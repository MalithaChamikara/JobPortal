...
<div class='container mt-5'>
    <div class="row justify-content-center">
        ...
        @endif
        @if(Auth::check() && auth()->user()->user_type=='employer')
        <p>Your membership {{now()->format('Y-m-d') > auth()->user()->billing_ends ? 'was expire' : 'will expire'}} on {{auth()->user()->billing_ends}} </p>
        @endif
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 mr-3">
                    ...
                    <div class="col-xl-3 col-md-6 mr-3">
                        <div class="card bg-success text-white mb-4">
                            <div class="card-body">User Plan({{ \App\Models\User::where('id',auth()->user()->id)->first()->plan}})</div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
